...
Выберите на устройстве файл CSV, из которого хотите добавить список. Список должен содержать от 2 до 65536 строк и быть в кодировке UTF-8.

Как загрузить список из файла CSV и решить возможные проблемы с кодировкой, можно посмотреть в видео:
