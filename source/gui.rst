...
Кнопка с изображением аватара (по умолчанию справа вверху) позволяет пройти авторизацию в сервисах NextGIS и получить расширенную функциональность программы при наличии подписки. Нажмите на кнопку и во всплывающем окне кликните "Войти". В открывшейся странице браузера ведите емейл, указанный при регистрации, и пароль NextGIS ID, после чего вернитесь в программу. Если при последующем нажатии на кнопку с аватаром во всплывающем окне есть надпись "На поддержке", то вся функциональность программы должна быть доступна. (`Как создать аккаунт <https://docs.nextgis.ru/docs_ngcom/source/create.html>`_).
