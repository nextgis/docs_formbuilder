...
.. only:: html
   ...
   Программа распространяется под лицензией `GPL v.2 <https://docs.nextgis.ru/docs_ngweb/source/appendix.html>`__.
...
Скачайте единый установщик программ NextGIS по адресу https://nextgis.ru/nextgis-formbuilder/ и запустите. Следуйте шагам мастера установки. После установки запустите появившийся ярлык на рабочем столе или в меню Пуск.
