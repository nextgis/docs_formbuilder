...
2. Создайте или импортируйте элементы на форме, поменяйте их состав и расположение, так, 
чтобы на итоговом устройстве можно было заполнить все поля о каждом добавляемом объекте.
